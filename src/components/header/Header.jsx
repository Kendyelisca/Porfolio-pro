...
const Header = ({ darkMode }) => {
  // Correct the prop name to 'darkMode'
        ...
        <div
          className={`${
            darkMode
              ...
              : 'primo bg-blue-300  relative text-gray-900'
          }`}
        >
          ...
          <p className="z-30 relative">{t('description')}</p>
          <div className="flex justify-center items-center gap-8">
            ...
            <div class="button-borders z-10">
              <button class="primary-button" onClick={handleOpenForm}>
                {t('ButtonText2')}
              </button>
            </div>
          </div>
